...
def main(unused_argv):
    ...
    prc = prc_query("Li10SnP2S12", driver)
    sop = sop_query("Li10SnP2S12", driver)
    ptp = ptp_query("Li10SnP2S12", driver)
    dev = dev_query("Li10SnP2S12", driver)
    print(prc,sop,ptp,dev)
